...
A segurança dos nossos usuários é nossa prioridade. Se você descobriu uma vulnerabilidade de segurança, pedimos que nos ajude a proteger nossos usuários seguindo estas diretrizes:
...
1. **Reporte Privadamente**
   - Use o recurso de [Security Advisories](https://github.com/rafaelakio/poc-glue-data-pipeline/security/advisories/new) do GitHub
...
- **GitHub Security**: [Security Advisories](https://github.com/rafaelakio/poc-glue-data-pipeline/security/advisories)

Para outras questões:
- **Issues**: [GitHub Issues](https://github.com/rafaelakio/poc-glue-data-pipeline/issues)
